...
class CRM_Stepw_APIWrapper {
  ...
  /**
   * API wrapper for 'prepare' event on 4.afform.submit
   *
  ...
  /**
   * API wrapper for 'respond' events on 4.afform.get
   *
   * FLAG_STEPW_AFFORM_BRITTLE
   *
   * @param Civi\API\Event\RespondEvent $event
  ...
  /**
   * API wrapper for 'respond' events on 4.afformsubmission.create
   *
   * @param Civi\API\Event\RespondEvent $event
   */
  private static function RESPOND_4_afformsubmission_create(Civi\API\Event\RespondEvent $event) {
    // note: here we will:
